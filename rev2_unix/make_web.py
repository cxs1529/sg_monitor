...
websiteDir = 'static_website' # specify desired directory to place static website files .html, .css, images, etc.

# Set the output directory for Frozen-Flask
app.config['FREEZER_DESTINATION'] = websiteDir
...
if __name__ == '__main__':
    ...
    freezer.freeze()
    print(f"Freezing complete! Your static site is in the {websiteDir} directory.")